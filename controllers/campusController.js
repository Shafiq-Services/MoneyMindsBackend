...
const createCampus = async (req, res) => {
  try {
    ...
    const responseData = {
      ...
      slug: campus.slug,
      title: campus.title,
      imageUrl: convertToFullUrl(campus.imageUrl),
      mainIconUrl: convertToFullUrl(campus.mainIconUrl),
      campusIconUrl: convertToFullUrl(campus.campusIconUrl),
...
const getUserCampuses = async (req, res) => {
  try {
    ...
    structuredUserCampuses.push({
      ...
      imageUrl: convertToFullUrl(moneyMindsCampus.imageUrl),
      mainIconUrl: convertToFullUrl(moneyMindsCampus.mainIconUrl),
      campusIconUrl: convertToFullUrl(moneyMindsCampus.campusIconUrl),
